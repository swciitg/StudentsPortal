...
const CreateLOR = () => {
    ...
    return (
      ...
      {currentPage === 1 && <CreateLORStep1 onNext={handleNext} formData={formData} setFormData={setFormData} />}
      {currentPage === 2 && <CreateLORStep2 onNext={handleNext} formData={formData} setFormData={setFormData} />}
      {currentPage === 3 && <CreateLORStep3 onComplete={handleComplete} formData={formData} setFormData={setFormData} />}
