...
const CreateInterIIT = () => {
    ...
    const handleComplete = async () => {
      try {
        ...
        interIITEvent:formData.interIITEvent,
    ...
    return (
      ...
      {currentPage === 1 && <CreateInterIITStep1 onNext={handleNext} formData={formData} setFormData={setFormData} />}
      {currentPage === 2 && <CreateInterIITStep2 onNext={handleNext} formData={formData} setFormData={setFormData} />}
      {currentPage === 3 && <CreateInterIITStep3 onComplete={handleComplete} formData={formData} setFormData={setFormData} />}
