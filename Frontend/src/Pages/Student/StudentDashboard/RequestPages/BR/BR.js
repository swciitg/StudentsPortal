...
const CreateBR = () => {
    ...
    return (
      ...
      {currentPage === 1 && <CreateBRStep1 onNext={handleNext} formData={formData} setFormData={setFormData} />}
      {currentPage === 2 && <CreateBRStep2 onNext={handleNext} formData={formData} setFormData={setFormData} />}
      {currentPage === 3 && <CreateBRStep3 onComplete={handleComplete} formData={formData} setFormData={setFormData} />}
