...
function CreateProjValStep1({onNext,formData,setFormData}) {
  CreateProjValStep1.propTypes = {
  ...
  const handleNext = () => {
    setFormData({ ...formData, ParentBody: ParentBody, Organisation: Organisation,ProjectName:ProjectName, ProjectRole:ProjectRole });
    onNext();
  };
  return (
