...
function CreateClubPORStep3({onComplete,formData,setFormData}) {
  ...
  const handleNext = () => {
    setFormData({ ...formData, Documentclaim: Documentclaim, SelectedFile: SelectedFile,Document:Document  });
    setLoading(true)
    onComplete();
  };
    ...
    <div className="bg-white px-10 w-[400px] pb-9 pt-9 shadow-[0_4px_8px_2px_rgba(0,0,0,0.16)] ">
      ...
      <div className="flex justify-between mt-10">
        ...
        Document.length > 0 ? (
          <div
          >
            <button onClick={handleNext} disabled={loading} className=" inline-flex items-center p-1 bg-[#2164E8] text-white rounded-sm pl-4 pr-4">
