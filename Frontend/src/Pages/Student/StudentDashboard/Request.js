        ...
        <div className=" flex justify-center items-center h-screen">
          <div className="flex gap-10">
            <div className="flex flex-col gap-4 items-center text-[#2164E8]">
              <Link to={`/StudentDashboard/Request/SelectValidation?e=${encodeURIComponent(encryptedEmail)}`}><button  className="lg:p-20 lg:px-24 p-10 px-12 cursor-pointer text-[rgba(33,100,232,1)] text-6xl font-medium bg-white shadow-[0px_1.6px_3.6px_0px_rgba(27,33,45,0.13),0px_0.3px_0.9px_0px_rgba(27,33,45,0.10)]">
                +
              </button></Link>
