    ...
    <div className=" relative h-screen w-[100%]">
      ...
      <div className=" absolute  h-screen w-[82%] ml-[18%] p-5 ">
        ...
        <div className=" grid gap-5 grid-cols-10 ">
          {/* Tile 1*/}
          <div className="h-[300px] flex flex-col gap-1 col-span-4  shadow-[0px_1.6px_3.6px_0px_rgba(27,33,45,0.13),0px_0.3px_0.9px_0px_rgba(27,33,45,0.10)]">
            {toggle1 === false ? (
              <div className="bg-white h-[20%]  shadow-[0px_1.6px_3.6px_0px_rgba(27,33,45,0.13),0px_0.3px_0.9px_0px_rgba(27,33,45,0.10)] flex items-center justify-between text-[#BCBEC2] pl-4 pr-4">
                <div className="flex gap-1 items-center"><div>Registration</div><img src="/Checkmark.svg" width="20px "/></div>
                <img
              ...
              <div className="bg-white border-l-[6px] p-3 pb-0 border-[#2164E8] h-[60%]  shadow-[0px_1.6px_3.6px_0px_rgba(27,33,45,0.13),0px_0.3px_0.9px_0px_rgba(27,33,45,0.10)] ">
                <div className=" flex flex-col gap-2">
                  ...
                  <div className=" flex justify-end ">
                    <Link to="/StudentDashboard/Profile"><button className="text-sm p-[5px] pl-3 pr-3 mt-4 bg-[#2164E8] text-white rounded">View Profile</button></Link>
                  </div>
                </div>
              </div>
            )}
            {toggle2 === false ? (
              ...
              <div className="bg-white border-l-[6px] p-3 pb-0 border-[#2164E8] h-[60%]  shadow-[0px_1.6px_3.6px_0px_rgba(27,33,45,0.13),0px_0.3px_0.9px_0px_rgba(27,33,45,0.10)] ">
                <div className="flex gap-2">
                 ...
                 <div className=" pr-5"> <p className="text-sm mt-3">Can put some text here explaining what requests are and what kinda request we can put like POR, LOR, etc.</p></div>
                  <div className=" flex justify-end ">
                    <Link to="/StudentDashboard/Request"><button className="text-sm p-[5px] pl-3 mt-8 pr-3 bg-[#2164E8] text-white rounded">Make a Request</button></Link>
                  </div>
              </div>
            )}
            {toggle3 === false ? (
        ...
        {  ManageRequests.map((item)=>(        <div key={item.id} className="bg-[#EFF6FC] p-2 flex justify-between items-center"><p className=" text-sm">{item.status}</p><p className="text-xs text-[#494D57]">{item.Date}</p></div>))}
                  </div>
                  <div className=" flex justify-end ">
                    <Link to="/StudentDashboard/History"><button className="text-sm p-[5px] pl-3 mt-4 pr-3 bg-[#2164E8] text-white rounded">Check my History</button></Link>
                  </div>
              </div>
            )}
          </div>
          {/* Tile 2*/}
          <div className=" col-span-3 p-7 pb-0 bg-white shadow-[0px_1.6px_3.6px_0px_rgba(27,33,45,0.13),0px_0.3px_0.9px_0px_rgba(27,33,45,0.10)]">
            ...
            <Link
              to="/StudentDashboard/Profile"
              className="text-[#2164E8] text-sm flex justify-end mt-12"
            >
              View profile
            </Link>
          </div>
          {/* Tile 3*/}
          <div className="p-7 pb-0 col-span-3 bg-white shadow-[0px_1.6px_3.6px_0px_rgba(27,33,45,0.13),0px_0.3px_0.9px_0px_rgba(27,33,45,0.10)]">
            ...
            <Link
              ...
              className="text-[#2164E8] text-sm flex justify-end mt-5"
            >
              View all Request Forwards
            </Link>
          </div>
          {/* Tile 4*/}
          <div className=" col-span-3 p-7 pb-0 bg-white h-[300px] shadow-[0px_1.6px_3.6px_0px_rgba(27,33,45,0.13),0px_0.3px_0.9px_0px_rgba(27,33,45,0.10)]">
          <div className="flex gap-2 items-center">
            ...
            <div className="flex flex-col gap-2 mt-3">
                {ApprovedRequests.map(item=>(<div key={item.id} className="bg-[#EFF6FC] flex justify-between items-center p-2">
            ...
            <Link
              to="/StudentDashboard/RequestsForward"
              className="text-[#2164E8] text-sm flex justify-end mt-6"
            >
              View all
            </Link>
          </div>
          {/* Tile 5*/}
          <div className=" col-span-4 p-7 pb-0  bg-white shadow-[0px_1.6px_3.6px_0px_rgba(27,33,45,0.13),0px_0.3px_0.9px_0px_rgba(27,33,45,0.10)]">
          <div className="flex gap-2 items-center">
          ...
          <div className="flex gap-2 items-center">
              ...
              Build my CV
                ...
                <div className="flex justify-center items-center h-full text-[#8D9096]">Coming soon...</div>
          </div>
        </div>
      </div>
    </div>
